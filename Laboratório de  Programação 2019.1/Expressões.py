...
for i in range(instancias):
    ...
    for j in string:
        if j == ")":
            if pilhaDeCaractere.isVazia():
                flag = False
                break
            elif pilhaDeCaractere.getFim().getDado() == "(":
                pilhaDeCaractere.remover()
                flag = True
            else:
                flag = False
                break
            ...
            pilhaDeCaractere.inserir(j)
    if flag == True:
        print("S")
    else:
        print("N")
        pilhaDeCaractere.esvaziaPilha()
